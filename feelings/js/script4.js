$.ajax({
  "url":"https://www.kimonolabs.com/api/7dpwtuyu?apikey=xsQYe5UGp2VeuXjGEKtWWjuCGl5HxI58",
  "crossDomain":true,
  "dataType":"jsonp",
  ...
  var collection = response.results.collection1;
    ...
    // Traverses through every element in the entire collection 
      ...
      var lifelesstwitter = collection[i].lifelesstwitter.text;
      ...
      $('.group3').append('<p>' + lifelesstwitter + '</p>');
