$.ajax({
  "url":"https://www.kimonolabs.com/api/af4hcura?apikey=xsQYe5UGp2VeuXjGEKtWWjuCGl5HxI58",
  "crossDomain":true,
  "dataType":"jsonp",
  ...
  var collection = response.results.collection1;
    ...
    // Traverses through every element in the entire collection 
      ...
      var twittersatisfied = collection[i].twittersatisfied.text;
      ...
      $('.group5').append('<p>' + twittersatisfied + '</p>');
